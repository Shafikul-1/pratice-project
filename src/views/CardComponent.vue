...
const AllDetalis = [
    {
        name: 'Fast Man Detalis',
        heading: {
            headingOne : 'explore our',
            headingTwo: 'awesome Components'
        },
        ...
        others: [
            {
                Heading: 'Zero Configrations',
                Paragrape: ' Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident ab nulla quod dignissimos vel non corrupti doloribus voluptatum eveniet',
                icon: '<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/> </svg>',
            },
            {
                Heading: 'Copy & paste components',
                Paragrape: ' Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident ab nulla quod dignissimos vel non corrupti doloribus voluptatum eveniet',
                icon: '<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"/> </svg>',
            },
            {
                Heading: 'elegant Dark Mode',
                Paragrape: ' Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident ab nulla quod dignissimos vel non corrupti doloribus voluptatum eveniet',
    ...
    {
        name: 'Second Man Details',
        heading: {
            headingOne : 'details Export',
            headingTwo: 'amaging Style'
        },
    ...
    {
        name: 'Thred Man Details',
        heading: {
            headingOne : 'Best Suggest',
            headingTwo: 'Linking Option Like'
        },
        image: 'https://cdn.pixabay.com/photo/2012/03/01/00/55/flowers-19830_640.jpg',
        others: [
            {
                Heading: 'Zero Configrations',
                Paragrape: ' Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident ab nulla quod dignissimos vel non corrupti doloribus voluptatum eveniet',
    ...
    {
        name: 'Four Man Details',
        heading: {
            headingOne : 'Awasom Portfolio',
            headingTwo: 'Best AnaunseMent'
        },
...
<template>
        <div class="">
            <div class="flex">
                <section class="clikingSide w-1/4 mt-10">
                    <div class="" @click="activeIndex = index" v-for="(details,index) in AllDetalis" :key="index">
                        <h2 class="py-4 cursor-pointer px-3 ml-4 bg-indigo-300 hover:bg-indigo-500 hover:text-white font-bold my-2 text-xl rounded">{{ details.name }}</h2>
                    </div>
                </section>

                <!-- Detalis all -->
                <section class="bg-white dark:bg-gray-900">  
                    <CardComponent :sobDetails="AllDetalis[activeIndex]"/>
                </section>
            </div>
        </div>
