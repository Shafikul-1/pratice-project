...
defineProps(
    {
        ...
        fastHeading: String,
        fastParagrape: String,
        secondHeading: String,
        secondParagrape: String,
        thredHeading: String,
        thredParagrape: String,
        logo: {
            logoFast: String,
            logoSecond: String,
            logoThred: String,
...
<p>{{ activeIndex }}</p>
        <div class="flex">
            <section class="clikingSide w-1/4 mt-10">
                <h1 @click="manFn[activeIndex]" class="ml-2 cursor-pointer font-bold text-xl rounded px-4 my-3 py-4 bg-indigo-200  hover:bg-indigo-600 hover:text-white" v-for="(man, index) in detalis" :key="index">{{ man }}</h1>
            </section>
            <!-- Detalis all -->
            ...
            <div class="container px-6 py-10 mx-auto">
                <div class="lg:flex lg:items-center">
                    <div class="w-full space-y-12 lg:w-1/2 ">
                        <div>
                            <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">{{ heading.headingOne }} <br> {{ heading.headingTwo }}</h1>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">{{ fastHeading }}</h1>

                                <p class="mt-3 text-gray-500 dark:text-gray-300">{{ fastParagrape }} </p>
                            </div>
                        </div>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">{{ secondHeading }}</h1>

                                <p class="mt-3 text-gray-500 dark:text-gray-300">{{ secondParagrape }}</p>
                            </div>
                        </div>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">{{ thredHeading }}</h1>

                                <p class="mt-3 text-gray-500 dark:text-gray-300">{{ thredParagrape }} </p>
                            </div>
                        </div>
                    </div>

                    <div class="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
                        <img class="w-[28rem] h-[28rem] object-cover xl:w-[34rem] xl:h-[34rem] rounded-full" :src="image" alt="">
                    </div>
                </div>
